      ...
      <div className="container mx-auto px-6 md:px-10 lg:px-16 pt-24 pb-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            >
              <span className="block">WILLIE CHEN</span>
            ...
            >
              Specialized in React • Node.js • Next • TypeScript
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4">
                <p className="text-gray-300 text-lg">HongKong</p>
            ...
            >
              ...
              <div className="flex items-center gap-2 text-gray-300">
                ...
                <span> venuswillie1216@gmail.com</span>
              </div>
            </motion.div>
          </motion.div>
